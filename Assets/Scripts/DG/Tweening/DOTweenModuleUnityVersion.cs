    ...
    public static class DOTweenModuleUnityVersion
    {
        ...
        public static DG.Tweening.Sequence DOGradientColor(UnityEngine.Material target, UnityEngine.Gradient gradient, float duration)
        {
                    ...
                    if(val_13 != 0)
            {
                ...
                DG.Tweening.Sequence val_11 = DG.Tweening.TweenSettingsExtensions.Append(s:  val_1, t:  DG.Tweening.TweenSettingsExtensions.SetEase<DG.Tweening.Core.TweenerCore<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>>(t:  DG.Tweening.ShortcutExtensions.DOColor(target:  target, endValue:  new UnityEngine.Color() {r = 4.438871E-11f, g = 4.438871E-11f, b = 4.438871E-11f, a = 4.438871E-11f}, duration:  (null - null) * duration), ease:  1));
            }
        ...
        public static DG.Tweening.Sequence DOGradientColor(UnityEngine.Material target, UnityEngine.Gradient gradient, string property, float duration)
        {
            ...
            if((val_13 == 0) && (null <= 0f))
            {
                    target.SetColor(name:  property, value:  new UnityEngine.Color() {r = 4.438871E-11f, g = 4.438871E-11f, b = 4.438871E-11f, a = 4.438871E-11f});
            }
            else
            {
                    if((val_2.Length - 1) == val_13)
                    ...
                    if(val_13 != 0)
            {
                ...
                DG.Tweening.Sequence val_11 = DG.Tweening.TweenSettingsExtensions.Append(s:  val_1, t:  DG.Tweening.TweenSettingsExtensions.SetEase<DG.Tweening.Core.TweenerCore<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>>(t:  DG.Tweening.ShortcutExtensions.DOColor(target:  target, endValue:  new UnityEngine.Color() {r = 4.438871E-11f, g = 4.438871E-11f, b = 4.438871E-11f, a = 4.438871E-11f}, property:  property, duration:  (null - null) * duration), ease:  1));
            }
        ...
        public static DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions> DOOffset(UnityEngine.Material target, UnityEngine.Vector2 endValue, int propertyID, float duration)
        {
            ...
            if((target.HasProperty(nameID:  propertyID)) != false)
            {
                ...
                val_7 = val_5;
                DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions> val_6 = DG.Tweening.TweenSettingsExtensions.SetTarget<DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions>>(t:  val_5, target:  (DOTweenModuleUnityVersion.<>c__DisplayClass8_0)[1152921507518564800].target);
            ...
            if(DG.Tweening.Core.Debugger._LogPrefix >= 1)
            {
                    DG.Tweening.Core.Debugger.LogMissingMaterialProperty(propertyId:  (DOTweenModuleUnityVersion.<>c__DisplayClass8_0)[1152921507518564800].propertyID);
            }
        ...
        public static DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions> DOTiling(UnityEngine.Material target, UnityEngine.Vector2 endValue, int propertyID, float duration)
        {
            ...
            if((target.HasProperty(nameID:  propertyID)) != false)
            {
                ...
                val_7 = val_5;
                DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions> val_6 = DG.Tweening.TweenSettingsExtensions.SetTarget<DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions>>(t:  val_5, target:  (DOTweenModuleUnityVersion.<>c__DisplayClass9_0)[1152921507518736192].target);
                return (DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions>)val_7;
            }
            
            if(DG.Tweening.Core.Debugger._LogPrefix >= 1)
            {
                    DG.Tweening.Core.Debugger.LogMissingMaterialProperty(propertyId:  (DOTweenModuleUnityVersion.<>c__DisplayClass9_0)[1152921507518736192].propertyID);
            }
