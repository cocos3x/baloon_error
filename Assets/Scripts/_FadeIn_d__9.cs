using UnityEngine;
private sealed class Cursor.<FadeIn>d__9 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public Cursor.<FadeIn>d__9(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        if((this.<>1__state) <= 1)
        {
            ...
            val_1 = val_1 * (this.<>4__this._settingData.fadeInSpeed);
